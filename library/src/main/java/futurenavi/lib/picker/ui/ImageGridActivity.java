...
import futurenavi.lib.picker.ImageDataSource;
import futurenavi.lib.picker.ImagePicker;
import futurenavi.lib.picker.adapter.ImageFolderAdapter;
import futurenavi.lib.picker.adapter.ImageGridAdapter;
...
//        imagePicker.setCrop(false);//不裁剪
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_ok) {
            Intent intent =this.getIntent();//new Intent();
