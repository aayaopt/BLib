package futurenavi.lib.picker.ui;
...
import futurenavi.lib.picker.view.SuperCheckBox;
...
//                mCbOrigin.setText(getString(R.string.origin));
    ...
    public void onImageSingleTap() {
        if (topBar.getVisibility() == View.VISIBLE) {
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pic_top_out));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pic_fade_out));
            ...
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pic_top_in));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pic_fade_in));
