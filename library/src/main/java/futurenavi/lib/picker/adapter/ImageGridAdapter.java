package futurenavi.lib.picker.adapter;
...
import futurenavi.lib.picker.Utils;
import futurenavi.lib.picker.bean.ImageItem;
import futurenavi.lib.picker.ui.ImageBaseActivity;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.pic_adapter_camera_item, parent, false);
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mActivity).inflate(R.layout.pic_adapter_image_list_item, parent, false);
                convertView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mImageSize)); //让图片是个正方形
