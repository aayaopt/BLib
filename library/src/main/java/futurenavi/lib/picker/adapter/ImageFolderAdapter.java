...
import futurenavi.lib.picker.bean.ImageFolder;
...
public class ImageFolderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.pic_adapter_folder_list_item, parent, false);
...
//            holder.folderCheck.setVisibility(View.VISIBLE);
            holder.folderCheck.setImageResource(R.mipmap.pic_list_selected);
        } else {
//            holder.folderCheck.setVisibility(View.INVISIBLE);
            holder.folderCheck.setImageResource(R.mipmap.pic_list_unselected);
        }
