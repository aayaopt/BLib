...
public class SwipeMenuLayout extends FrameLayout implements SwipeSwitch {
    ...
    public SwipeMenuLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ERecyclerSwipeMenuLayout);
        mLeftViewId = typedArray.getResourceId(R.styleable.ERecyclerSwipeMenuLayout_leftViewId, mLeftViewId);
        mContentViewId = typedArray.getResourceId(R.styleable.ERecyclerSwipeMenuLayout_contentViewId, mContentViewId);
        mRightViewId = typedArray.getResourceId(R.styleable.ERecyclerSwipeMenuLayout_rightViewId, mRightViewId);
        typedArray.recycle();
