...
public class EVideoAct extends AppCompatActivity implements UniversalVideoView.VideoViewCallback{
    ...
    private static final String VIDEO_URL = "http://okbrselg1.bkt.clouddn.com/video/v0001.mp4";//http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoView.start();
//        mMediaController.setTitle("This is text Video");
